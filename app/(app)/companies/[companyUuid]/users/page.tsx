  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
      <PageHeader
        ...
        action={
          <Button nativeButton={false} render={<Link href={`/companies/${companyUuid}/users/new`} />}>
      ...
      {isLoading ? (
        ...
        >
          {!search && (
            <Button nativeButton={false} render={<Link href={`/companies/${companyUuid}/users/new`} />} className="mt-2">
              <UserPlus className="mr-2 size-4" />
              Create User
            </Button>
          )}
