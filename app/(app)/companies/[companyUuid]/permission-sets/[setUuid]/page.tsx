...
export default function CompanyPermissionSetDetailPage() {
        ...
        action={
          <div className="flex gap-2">
            <Button
              variant="outline"
              nativeButton={false}
              render={<Link href={`/companies/${companyUuid}/permission-sets`} />}
            >
            ...
            <Button
              ...
              render={
                <Link
                  href={`/companies/${companyUuid}/permission-sets/${setUuid}/edit`}
                />
              }
            >
            ...
            <Button
              ...
              render={
                <Link
                  href={`/companies/${companyUuid}/permission-sets/${setUuid}/permissions`}
                />
              }
            >
