            ...
            <TableBody>
              {roles.map((role) => (
                <TableRow
                  ...
                  onClick={() => router.push(`/roles/${role.publicId}`)}
                >
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                        <DropdownMenuItem onClick={(e) => { e.stopPropagation(); router.push(`/roles/${role.publicId}`) }}>
                          <Eye className="mr-2 size-4" /> View
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={(e) => { e.stopPropagation(); router.push(`/roles/${role.publicId}/edit`) }}>
                          <Edit className="mr-2 size-4" /> Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem onClick={(e) => { e.stopPropagation(); router.push(`/roles/${role.publicId}/permissions`) }}>
