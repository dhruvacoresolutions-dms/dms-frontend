      ...
      <PageHeader
        ...
        action={
          <div className="flex gap-2">
            <Button variant="outline" nativeButton={false} render={<Link href={`/permission-sets`} />}>
              <ArrowLeft className="mr-2 size-4" /> Back
            </Button>
            <Button nativeButton={false} render={<Link href={`/permission-sets/${setUuid}/edit`} />}>
              <Edit className="mr-2 size-4" /> Edit
            </Button>
            <Button variant="outline" nativeButton={false} render={<Link href={`/permission-sets/${setUuid}/permissions`} />}>
